<?php
	...
	if (isset($_POST['fees_name'])) {
		$fees_name = filter_var($_POST['fees_name'], FILTER_SANITIZE_SPECIAL_CHARS);
		$parent_id = preg_replace("#[^0-9]#", "", $_POST['parent_id']);
		$branch_id = preg_replace("#[^0-9]#", "", $_POST['branch_id']);
		$fee_choice = filter_var(trim($_POST['fee_choice']), FILTER_SANITIZE_SPECIAL_CHARS);
		$loan_fees = filter_var($_POST['loan_fees'], FILTER_SANITIZE_SPECIAL_CHARS);
		$symbol = $_POST['symbol'];
