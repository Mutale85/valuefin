...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		<?php include ("../nav_side.php"); 
			...
			$sql = $connect->prepare("SELECT * FROM loans_table WHERE loan_number = ?");
			$sql->execute(array($_GET['loan_number']));
			$rows = $sql->fetch();
			if ($rows) {
				$ID = $rows['id'];
			}
      						...
      						<div class="card card-warning">
      							...
      							<div class="card-body">
		      						<div class="table table-responsive">
			      						<table id="loansTable" class="cell-table table table-sm" style="width:100%">
											<thead>
												<th>Loan#</th>
												<th>From</th>
												<th>Maturity</th>
											...
											<tbody class="text-dark">
		      								<?php
		      									// 
		      									$query = $connect->prepare("SELECT * FROM loans_table WHERE branch_id = ? AND parent_id = ? AND borrower_id = ? AND loan_number = ? ");
												$query->execute(array($BRANCHID,  $_SESSION['parent_id'], $_GET['borrower_id'], $_GET['loan_number']));
				                ...
				                <div class="tab-content" id="custom-tabs-two-tabContent">
				                  	...
				                  	<div class="tab-pane fade" id="custom-tabs-two-messages" role="tabpanel" aria-labelledby="custom-tabs-two-messages-tab">
				                     	...
				                     	<div class="box-body table-responsive no-padding">
				                     		<table class="cell-table table table-sm" id="ScheduleTable" style="width: 100%">
				                     			<thead>
				                     				<tr>
				                     					<th>Repayments</th>
				                     					<th>Dates:</th>
				                     			...
				                     			<tbody class="text-dark">
				                     				<?php
				                     					...
				                     					$period = 1;
				                     					$num = 1;
				                     					$query = $connect->prepare("SELECT * FROM loan_schedules  WHERE loan_id = ?");
				                     					$query->execute(array($_GET['loan_number']));
				                     					...
				                     					?>
				                     						...
				                     						<tr>
				                     							<td><?php echo $num++?></td>
				                     							<td><?php echo date("Y-m-d", strtotime($row['date_due'])); ?></td>
				                  	...
				                  	<div class="tab-pane fade" id="custom-tabs-two-settings" role="tabpanel" aria-labelledby="custom-tabs-two-settings-tab">
				                  		<div class="mb-3">
				                  			<a href="collaterals/collateral?loan_number=<?php echo $_GET['loan_number']?>&borrower_id=<?php echo $_GET['borrower_id']?>" class="btn btn-primary shadow">Add Collateral</a>
				                  		</div>
				                  		<div class="table table-responsive">
				                  			<table class="cell-table table table-sm" id="collaTable" style="width: 100%">
				                  				<thead>
				                  					<th>Type</th>
				                  					<th>Name</th>
				                  					<th>Registration</th>
