<?php
	...
	if (isset($_POST['delete_branch_id'])) {
		...
		if ($de->execute(array($branch_id))) {
			...
			$de = $connect->prepare("DELETE FROM `loans` WHERE branch_id = ?");
			$de->execute(array($branch_id));

			$de = $connect->prepare("DELETE FROM `loan_offciers` WHERE branch_id = ?");
			$de->execute(array($branch_id));

			$de = $connect->prepare("DELETE FROM `loan_payments` WHERE branch_id = ?");
			$de->execute(array($branch_id));

			$de = $connect->prepare("DELETE FROM `loan_schedules` WHERE branch_id = ?");
			$de->execute(array($branch_id));

			$de = $connect->prepare("DELETE FROM `payroll` WHERE branch_id = ?");
			$de->execute(array($branch_id));

			$de = $connect->prepare("DELETE FROM `payroll_allowances` WHERE branch_id = ?");
			$de->execute(array($branch_id));

			$de = $connect->prepare("DELETE FROM `payroll_deductions` WHERE branch_id = ?");
			$de->execute(array($branch_id));

			$de = $connect->prepare("DELETE FROM `salary_allowances` WHERE branch_id = ?");
			$de->execute(array($branch_id));

			$de = $connect->prepare("DELETE FROM `salary_deductions` WHERE branch_id = ?");
			$de->execute(array($branch_id));
