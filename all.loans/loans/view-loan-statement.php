			          ...
			          <div class="col-12 mt-5">
			            ...
			            <div class="invoice p-3 mb-3">
			              	<div class="row">
				                <div class="col-12">
				                  <h4>
				                    <img src="members/adminphotos/<?php echo $org_logo?>" alt="<?php echo $org_logo?>" class="img-fluid img-responsive" width="80">
			              ...
			              <!-- Table row -->
		                	...
		                	<div class="d-flex. justify-content-between">
		                		<a href="loans/print-loan-statement?loan_number=<?php echo $loan_number?>&applicant_id=<?php echo $borrower_id?>" target="_blank" class="button-55" role="button"> <i class="bi bi-printer"></i> PRINT Statement</a>
		                	</div>
			          	</div>
			        </div>
			    </div>
