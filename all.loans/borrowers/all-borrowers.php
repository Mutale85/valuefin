							        	...
							        	<?php 
							        		...
							        		if ($count > 0) {
							        			foreach ($res as $row) {
							        				...
							        				if ($row['borrower_working_status'] == 'Business') {
							        					$status = '
							        						<h4 class="text-secondary"><span id="working_span">Business Details</span></h4>

										                	<table class="table table-bordered">
										                  		<tr>
										                    		<td style="font-weight:bold;">Business Type:</td> <td>'.$row['borrower_business_type'].'</td>
										                  		</tr>
										                  		<tr>
										                    		<td style="font-weight:bold;">Business Name</td> <td>'.$row['borrower_business'].'</td>
										                  		</tr>
										                  		<tr>
										                    		<td style="font-weight:bold;">Business Address</td> <td>'.$row['borrower_business_address'].'</td>
										                  		</tr>
										                	</table>
							        					';
							        				}else{
							        					$status = '
							        						<table class="table table-bordered">
										                  		<tr>
										                    		<td style="font-weight:bold;">Employer</td> <td>'.$row['borrower_employer_name'].'</td>
										                  		</tr>
										                  		<tr>
										                    		<td style="font-weight:bold;">Employers Phone</td> <td>'.$row['borrower_employer_phone'].'</td>
										                  		</tr>
										                  		<tr>
										                    		<td style="font-weight:bold;">Employers Address</td> <td>'.$row['borrower_employer_address'].'</td>
										                  		</tr>
										                	</table>
							        					';
							        				}
