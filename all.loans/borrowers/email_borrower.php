      				...
      				<div class="row">
      					<div class="col-md-12">     						
      						<div class="card card-primary">
  								...
  								<?php 
  									$query = $connect->prepare("SELECT * FROM borrowers_details WHERE branch_id = ? AND parent_id = ? AND display = '1'  AND borrower_email != '' ");
	...
	<script>
		...
		$("#emailBtn").click(function(){
			if ($(".checkSingle").is(":checked")) {
				...
				$.ajax({
					url:"borrowers/sendEmailMessage",
					method:"post",
					data:formData,
					cache:false,
					processData:false,
