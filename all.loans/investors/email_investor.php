											...
											<table class="cell-table" id="myTable">  
												...
												<?php  
													...
													<tr id="<?php echo $row['id']?>">
														<td><input type="checkbox" name="reciever_email[]" class="checkSingle" data-username="<?php echo $row['firstname'] ?>" id="reciever_email" value="<?php echo $row['email']?>">
														</td>
														<td><?php echo $row['firstname'] ?></td>
														<td><?php echo $row['lastname']?></td>
														<td><?php echo $email?></td>
														<td><a href="SMSFIles/sentEmails?user_email=<?php echo $row['email']?>&username=<?php echo $row['firstname'] ?>">View <?php echo countEmails($connect, $row['email'], $_SESSION['parent_id'])?> Email</a></td>
														<td data-column="Edit">
